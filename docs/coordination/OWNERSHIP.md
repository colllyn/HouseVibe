...
| mobile-ui-engineer | `src/components/ui/**`, `src/components/layout/**`, `src/components/responsive/**`, `src/hooks/use-responsive*.ts`, `src/app/globals.css`, `src/app/layout.tsx`, `src/app/(dashboard)/layout.tsx`, `src/app/(dashboard)/page.tsx`, `src/features/matching/components/**`, `docs/handoffs/**` |
