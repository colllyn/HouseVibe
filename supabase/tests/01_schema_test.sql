...
SELECT col_not_null('public', 'audit_logs', 'workspace_id', 'audit_logs.workspace_id NOT NULL');
...
SELECT is(
  ...
  0, 'audit_logs: 0 RLS policies (service_role only)'
);

-- =============================================================================
-- 11. Helper functions and RPC
-- =============================================================================
